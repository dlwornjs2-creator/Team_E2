...
명세 v4 8장/11장은 원래 "런타임 OBJ 로딩"과 "자유 회전 인터랙티브 3D 뷰어"를
금지했다. 2026-08-05 사용자 결정으로 홈 화면 "찾고 있는 3d 모델" 패널에 한해
예외를 둔다 (docs/hidden_object_search_ui_spec_v4.md 상단 정정 참고).
